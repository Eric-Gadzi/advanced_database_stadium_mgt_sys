...
<!Doctype HTML>
	...
	<div id="main">
		...
		<div class="head">
			<div class="col-div-6">
	<span style="font-size:30px;cursor:pointer; color: white;" class="nav"  >☰  Stadiums</span>
	<span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  >☰  Stadiums</span>
	</div>
		...
		<div class="col-div-8">
			...
			<div class="content-box">
				...
				<p>Stadium <input type="text" name="search" style="margin-left: 500px;"><button style="color: #f7403b;">Search</button></p>
				<br/>
				<table>
                    <tr>
                      ...
                      <!-- <tr>
                        ...
                        <td>50000</td>
                        <td>75</td>
                        <td><button>See Events</button></td>
                      </tr> -->
<?php display_stadium_details(); ?>
