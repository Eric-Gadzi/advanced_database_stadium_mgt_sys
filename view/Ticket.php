<!Doctype HTML>
	...
	<div id="main">
		...
		<div class="head">
			<div class="col-div-6">
	<span style="font-size:30px;cursor:pointer; color: white;" class="nav"  >☰  Ticket</span>
	<span style="font-size:30px;cursor:pointer; color: white;" class="nav2"  >☰ Ticket</span>
	</div>
		...
		<div class="col-div-8">
			...
			<div class="content-box">
				...
				<p>Ticket <input type="text" name="search" style="margin-left: 500px;"><button style="color: #f7403b;">Search</button></p>
				<br/>
				<table>
                    <tr>
